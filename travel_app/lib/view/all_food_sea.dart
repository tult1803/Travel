    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Container(
          ...
          child: widget.seaName == "Cần Giờ" ? foodCanGio() : foodVungTau(),
        ),
      ),
    );
  }
    ...
    return Column(
      children: [
        ...
        foodContainer(context,
            ...
            linkImg: "images/lau_ca_duoi_TCD.jpg"),
        foodContainer(context,
            color: Colors.white,
            ...
            linkImg: "images/quan_nuong_co_nen.jpg"),
        foodContainer(context,
            color: Colors.white,
        ...
        foodContainer(context,
            ...
            linkImg: "images/trung_long_dao.png"),
      ],
    );
  }
